...
@Mapper
public interface ${tableName}Dao extends Base${tableName}Dao {
	
     /**
     * 기본 insert, update, delete 메소드는 Base${tableName}Dao 클래스에 구현 되어있습니다.
     * Base${tableName}Dao는 절대 수정 불가 하며 새로운 메소드 추가 하실 경우에는 해당 소스에서 작업 하시면 됩니다.
     * 
	 *	※ 중 요 ※
     * 
